 ...
 * </p>
 */
public class LeaderLatchModified implements Closeable
{
     ...
     */
    public LeaderLatchModified(CuratorFramework client, String latchPath)
    {
     ...
     */
    public LeaderLatchModified(CuratorFramework client, String latchPath, String id)
    {
     ...
     */
    public LeaderLatchModified(CuratorFramework client, String latchPath, String id, CloseMode closeMode)
    {
